...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "IAPIConsumer",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IAPIConsumer__factory>;
    getContractFactory(
      name: "ReputationAccessor",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.ReputationAccessor__factory>;
    getContractFactory(
      name: "MockOracle",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.IAPIConsumer>;
    getContractAt(
      name: "ReputationAccessor",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.ReputationAccessor>;
    getContractAt(
      name: "MockOracle",
      address: string,
      signer?: ethers.Signer
